      ...
      <div className={qaStyles.wrapper}>
        <div className={qaStyles.container}>
          ...
          <p className={qaStyles.answer}>
            ...
            <br/>
            وبنسبة ل الاسم احنا في هيرب بروجكت مؤمنين ان الالفاظ دي مجرد طرق تعبير اخترعها المجتمع المصري ومنتشره بكثره في الشارع ومفهاش حاجه غلط او عيب.
          </p>
